...
(function() {
    ...
    , v = function(a, b) {
        ...
        for (var d; a.length && (d = a.shift()); )
            !a.length && m(b) ? c[d] = b : c = c[d] && Object.prototype.hasOwnProperty.call(c, d) ? c[d] : c[d] = {}
    }, w = function(a, b) {
        function c() {}
        c.prototype = b.prototype;
        a.cb = b.prototype;
    ...
    var za = function(a, b, c, d) {
      ...
      , Ca = function(a, b, c) {
        r(a) || za("Expected function but got %s: %s.", [ka(a), a], b, Array.prototype.slice.call(arguments, 2))
    };
    ...
    Ya.prototype.clear = function() {
        this.K = {};
        this.gb = this.ha = this.l.length = 0
    }
    ;
    Ya.prototype.remove = function(a) {
        return ab(this.K, a) ? (delete this.K[a],
        this.ha--,
        this.gb++,
        this.l.length > 2 * this.ha && Za(this),
        !0) : !1
    }
    ;
    var Za = function(a) {
    ...
    var eb = z("Opera"), A = z("Trident") || z("MSIE"), fb = z("Edge"), gb = z("Gecko") && !(-1 != Ta.toLowerCase().indexOf("webkit") && !z("Edge")) && !(z("Trident") || z("MSIE")) && !z("Edge"), hb = -1 != Ta.toLowerCase().indexOf("webkit") && !z("Edge"), ib = function() {
        var a = l.document;
    ...
    tb.prototype.log = function(a, b, c) {
        if (a.value >= Db(this).value)
            for (r(b) && (b = b()),
            a = new rb(a,String(b),this.Bc),
            c && (a.Qb = c),
            c = "log:" + a.Ac,
            l.console && (l.console.timeStamp ? l.console.timeStamp(c) : l.console.markTimeline && l.console.markTimeline(c)),
            l.msWriteProfilerMark && l.msWriteProfilerMark(c),
            c = this; c; ) {
                var d = c
                  , e = a;
                if (d.Sa)
                    for (var f = 0; b = d.Sa[f]; f++)
                        b(e);
                c = c.getParent()
            }
    }
    ...
    ;
    var Jb = function(a, b) {
        a.Ma ? m(void 0) ? b.call(void 0) : b() : (a.pa || (a.pa = []),
        a.pa.push(m(void 0) ? u(b, void 0) : b))
    };
    ...
    var Nb = function(a, b) {
        ...
        if (a) {
            ...
            null === d ? (this.offsetX = hb || void 0 !== a.offsetX ? a.offsetX : a.layerX,
    ...
    Tb.prototype.add = function(a, b, c, d, e) {
        ...
        var h = Ub(a, b, d, e);
        -1 < h ? (b = a[h],
        c || (b.kb = !1)) : (b = new Rb(b,this.src,f,!!d,e),
        b.kb = c,
        a.push(b));
        return b
    }
    ...
    var Vb = function(a, b) {
        var c = b.type;
        c in a.w && Ia(a.w[c], b) && (Sb(b),
        0 == a.w[c].length && (delete a.w[c],
        a.eb--))
    };
    Tb.prototype.ic = function(a) {
        ...
        for (c in this.w)
            if (!a || c == a) {
                for (var d = this.w[c], e = 0; e < d.length; e++)
                    ++b,
                    Sb(d[e]);
                delete this.w[c];
                this.eb--
    ...
    var Ub = function(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.Ka && f.listener == b && f.capture == !!c && f.pb == d)
                return e
        }
        return -1
    };
    var Wb = "closure_lm_" + (1E6 * Math.random() | 0)
      ...
      , dc = function(a, b, c, d, e) {
        if ("array" == ka(b))
            ...
            c = Zb(c),
            Pb(a) ? a.fb(b, c, d, e) : a && (a = $b(a)) && (b = a.Qa(b, c, !!d, e)) && ec(b)
    }
      , ec = function(a) {
        if (!q(a) && a && !a.Ka) {
            var b = a.src;
    ...
    g.dispatchEvent = function(a) {
        ...
        var e = !0, f;
        if (b)
            for (var h = b.length - 1; !a.ta && 0 <= h; h--)
                f = a.currentTarget = b[h],
                e = kc(f, d, !0, a) && e;
        a.ta || (f = a.currentTarget = c,
        e = kc(f, d, !0, a) && e,
        a.ta || (e = kc(f, d, !1, a) && e));
        if (b)
            for (h = 0; !a.ta && h < b.length; h++)
                f = a.currentTarget = b[h],
                e = kc(f, d, !1, a) && e;
        return e
    }
    ...
    L.prototype.Qa = function(a, b, c, d) {
        return this.O.Qa(String(a), b, c, d)
    }
    ;
    L.prototype.hasListener = function(a, b) {
        return this.O.hasListener(m(a) ? String(a) : void 0, b)
    }
    ;
    var jc = function(a) {
        x(a.O, "Event target is not initialized. Did you call the superclass (goog.events.EventTarget) constructor?")
    };
    var M = function(a, b) {
        this.xa = b;
        this.Vb = !0;
    ...
    M.prototype.aa = function() {
        return "CastChannel[" + this.xa + " " + this.Ca.ia() + "]"
    }
    ;
    ...
    ;
    M.prototype.getNamespace = M.prototype.ia;
    M.prototype.Nd = function() {
        return this.xa
    }
    ;
    M.prototype.getSenderId = M.prototype.Nd;
    M.prototype.$a = function(a) {
        E(lc, C, "Dispatching CastChannel message [" + this.Ca.ia() + ", " + this.xa + "]: " + a.data);
    ...
    M.prototype.close = function() {
        if (this.Vb) {
            this.Vb = !1;
            H(lc, "Closing CastChannel [" + this.Ca.ia() + ", " + this.xa + "]");
            var a = new mc("close",this.xa);
            if (this.onClose)
                this.onClose(a);
            this.c(a);
            this.h.I();
            E(lc, C, "Disposed " + this.aa())
        }
    }
    ;
    ...
    nc.prototype.get = function() {
        ...
        a = this.qb,
        this.qb = a.next,
        a.next = null) : a = this.bd();
        return a
    }
    ;
    nc.prototype.put = function(a) {
        this.ge(a);
        this.yb < this.Ud && (this.yb++,
        a.next = this.qb,
        this.qb = a)
    }
    ;
    ...
    rc.prototype.add = function(a, b) {
        var c = tc.get();
        c.set(a, b);
        this.Hb ? this.Hb.next = c : (x(!this.Aa),
        this.Aa = c);
        this.Hb = c
    }
    ;
    ...
    var yc = function(a, b) {
        ...
        if (-1 != String(l.Promise).indexOf("[native code]")) {
            ...
            uc = function() {
                var a = zc;
                !r(l.setImmediate) || l.Window && l.Window.prototype && !z("Edge") && l.Window.prototype.setImmediate == l.setImmediate ? (pc || (pc = qc()),
                pc(a)) : l.setImmediate(a)
            }
    ...
    var N = function(a, b) {
      ...
      , Cc = function() {
        this.next = this.context = this.Ia = this.qa = this.ga = null;
        this.jb = !1
    };
    Cc.prototype.reset = function() {
        this.context = this.Ia = this.qa = this.ga = null;
        this.jb = !1
    }
    ;
    ...
    var Jc = function(a, b) {
        if (0 == a.D)
            if (a.H) {
                var c = a.H;
                if (c.V) {
                    for (var d = 0, e = null, f = null, h = c.V; h && (h.jb || (d++,
                    h.ga == a && (e = h),
                    !(e && 1 < d))); h = h.next)
                        e || (f = h);
                    e && (0 == c.D && 1 == d ? Jc(c, b) : (f ? (d = f,
                    x(c.V),
                    x(null != d),
                    d.next == c.Ba && (c.Ba = d),
                    d.next = d.next.next) : Kc(c),
                    Lc(c, e, 3, b)))
                }
                a.H = null
            } else
        ...
        if (0 == a.D) {
            ...
            a: {
                var e = c
                  ...
                  , h = a.we;
                if (e instanceof N)
                    null != f && Ca(f, "opt_onFulfilled should be a function."),
                    null != h && Ca(h, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"),
                    Nc(e, Ec(f || n, h || null, a)),
                    d = !0;
                else {
                    var t;
                    if (e)
    ...
    g = Uc.prototype;
    g.open = function(a, b) {
        x(l.WebSocket, "This browser does not support WebSocket");
        x(!this.Ua(), "The WebSocket is already open");
        null != this.ua && l.clearTimeout(this.ua);
        this.ua = null;
        this.Y = a;
        (this.Ja = b) ? (H(this.G, "Opening the WebSocket on " + this.Y + " with protocol " + this.Ja),
        this.F = new WebSocket(this.Y,this.Ja)) : (H(this.G, "Opening the WebSocket on " + this.Y),
        this.F = new WebSocket(this.Y));
        this.F.onopen = u(this.Yd, this);
        this.F.onclose = u(this.Xd, this);
        this.F.onmessage = u(this.L, this);
        this.F.onerror = u(this.ac, this)
    }
    ;
    g.close = function() {
        null != this.ua && l.clearTimeout(this.ua);
        this.ua = null;
        this.F && (H(this.G, "Closing the WebSocket."),
        this.Mb = !0,
        this.F.close(),
        this.F = null)
    }
    ...
    ;
    g.Yd = function() {
        H(this.G, "WebSocket opened on " + this.Y);
    ...
    ;
    g.Xd = function(a) {
        H(this.G, "The WebSocket on " + this.Y + " closed.");
        this.dispatchEvent("a");
        this.F = null;
        this.Mb ? (H(this.G, "The WebSocket closed normally."),
        this.Y = null,
        this.Ja = void 0) : (G(this.G, "The WebSocket disconnected unexpectedly: " + a.data),
        this.$c && (H(this.G, "Seconds until next reconnect attempt: " + Math.floor(this.xb / 1E3)),
        this.ua = Sc(u(this.open, this, this.Y, this.Ja), this.xb, this),
        this.ab++,
        this.xb = this.Tb(this.ab)));
        this.Mb = !1
    }
    ...
    ;
    g.open = function() {
        this.ra ? G(bd, this.Pa() + " Already open") : cast.__platform__.channel.open(u(this.ec, this), u(this.L, this))
    }
    ;
    g.close = function() {
    ...
    var ed = function() {
        this.N = null;
        cast.__platform__ && cast.__platform__.channel ? (H(cd, "Opening platform websocket"),
        dd(this, new ad)) : (H(cd, "Opening net websocket"),
        dd(this, new Uc(!0)));
        this.h = new L
    };
    ...
    var dd = function(a, b) {
        a.N && a.N.I();
        a.N = b;
        a.N.addEventListener("d", a.ec.bind(a));
        a.N.addEventListener("a", a.Zb.bind(a));
        a.N.addEventListener("b", a.ac.bind(a));
        a.N.addEventListener("c", a.L.bind(a))
    }
      , gd = function(a, b) {
        Ib(cd, a.Pa() + " " + b);
    ...
    g.open = function() {
        ...
        this.N.open("ws://localhost:" + $c("port-for-web-server") + "/v2/ipc")
    }
    ;
    g.close = function() {
    ...
    var O = function(a, b, c, d) {
        ...
        this.serializeMessage = this.Ad;
        this.deserializeMessage = this.fd;
        this.A = {};
        a = ia(c);
        for (b = a.next(); !b.done; b = a.next())
            this.A[b.value] = null;
        this.Wd = this.$a.bind(this);
        this.ja.addEventListener(this.S, this.Wd)
    };
    k(O, I);
    ...
    ;
    O.prototype.getNamespace = O.prototype.ia;
    O.prototype.Kd = function() {
        return this.oa
    }
    ;
    O.prototype.getMessageType = O.prototype.Kd;
    ...
    O.prototype.send = function(a, b) {
        this.Wb || "urn:x-cast:com.google.cast.system" == this.S || Hb(hd, "Application should not send requests before the system is ready (they will be ignored)");
        if (!this.fc || !this.fc(a, this.S, b))
            if ("STRING" == this.oa) {
                if (!p(b))
                    throw Error("Wrong argument, CastMessageBus type is STRING");
                this.ja.send(this.S, a, b)
            } else
                this.ja.send(this.S, a, this.serializeMessage(b))
    }
    ;
    ...
    O.prototype.Ed = function(a) {
        if (Pa(this.A, a))
            return this.A[a] || (this.A[a] = new M(this,a)),
            this.A[a];
        throw Error("Requested a socket for a disconnected sender: " + a);
    }
    ;
    O.prototype.getCastChannel = O.prototype.Ed;
    ...
    O.prototype.C = function() {
        ...
        this.h.I();
        for (var a in this.A)
            this.A[a] && this.A[a].close();
        this.A = {};
        E(hd, C, "Disposed " + this.aa())
    }
    ;
    ...
    var zd = function() {
        ...
        this.R = this.$.Oa("urn:x-cast:com.google.cast.inject", "JSON");
        this.R.onMessage = this.L.bind(this);
        for (var a = ia(["urn:x-cast:com.google.cast.cac", "urn:x-cast:com.google.cast.media"]), b = a.next(); !b.done; b = a.next())
            if (b = this.$.u[b.value] || null)
                b.fc = this.he
    };
    zd.prototype.L = function(a) {
        ...
        a = a.senderId;
        if ("WRAPPED" != b.type)
            this.M("Unsupported message type " + b.type, a, c);
        else {
            ...
            if (e) {
                var f = !1;
                if ("urn:x-cast:com.google.cast.cac" == d)
                    b.data.requestId = c,
                    f = !0;
                    ...
                    this.M("Unsupported namespace " + d, a, c);
                    return
                }
                this.bb.set(c, a);
                try {
                    ...
                    e.$a(new fd(d,"__inject__",t))
                } catch (y) {
                    throw this.bb.remove(c),
                    this.M("Injecting " + b.data + " failed with " + y, a, c),
                    y;
                }
                f || (this.ib ? this.M("Error " + JSON.stringify(this.ib), a, c, "WRAPPED_ERROR", this.ib) : (this.bb.remove(c),
                Ad(this, a, c)))
            } else
                this.M("Unregistered namespace " + d, a, c, "WRAPPED_ERROR", {
                    type: "ERROR",
    ...
    zd.prototype.ie = function(a, b, c) {
        if ("urn:x-cast:com.google.cast.media" == b && "STRING" == (this.$.u[b] || null).oa)
            try {
                c = JSON.parse(c)
            } catch (e) {
                return G(Bd, "Parse failed: " + c),
                !1
            }
        var d = c.type;
        ...
        a = c.requestId;
        if (!m(a))
            return Hb(Bd, "No requestId in " + c),
            !0;
        ...
        d = this.bb.get(a);
        if (!d)
            return G(Bd, "Request not found " + a),
            !0;
        this.bb.remove(a);
        if ("urn:x-cast:com.google.cast.cac" != b)
            return G(Bd, "Unsupported namespace " + b),
            !0;
        b = c;
        switch (b.type) {
        case "SUCCESS":
            ...
            break;
        case "ERROR":
            this.M("Wrapped error", d, a, "WRAPPED_ERROR", b);
            break;
        default:
            this.M("Unknown message type " + c, d, a)
        }
        return !0
    }
    ;
    zd.prototype.M = function(a, b, c, d, e) {
        G(Bd, a);
        this.R.send(b, new Cd(c,d || "INJECT_ERROR",m(e) ? JSON.stringify(e) : void 0))
    }
    ;
    var Ad = function(a, b, c, d) {
        a.R.send(b, new Dd(c,d))
    };
    ja(zd);
    ...
    var P = function() {
        ...
        this.T = {};
        this.h = new L;
        this.fa = new O("urn:x-cast:com.google.cast.system",this.ja,Oa(this.T),"JSON");
        Jb(this, pa(Kb, this.fa));
        ...
        this.Wc = null;
        this.u = {};
        this.bc = this.onMaxVideoResolutionChanged = this.onFeedbackStarted = this.onStandbyChanged = this.onVisibilityChanged = this.onSystemVolumeChanged = this.onSenderDisconnected = this.onSenderConnected = this.onShutdown = this.onReady = null;
        this.fa.addEventListener("SystemSender", this.Zd.bind(this));
        K(window, "unload", this.gc, !1, this);
        K(document, "visibilitychange", this.Dc, !1, this);
        E(Q, ub, "Version: 2.0.0.0050");
        Gd && Gd(this)
    };
    k(P, I);
    ...
    ;
    P.prototype.getApplicationData = P.prototype.Dd;
    P.prototype.Gd = function() {
        return this.pc
    }
    ;
    P.prototype.getDeviceCapabilities = P.prototype.Gd;
    P.prototype.je = function(a) {
        this.ub() ? Id(this, a) : this.B.statusText != a && (this.B.statusText = a,
        this.Za = !0)
    }
    ;
    P.prototype.setApplicationState = P.prototype.je;
    P.prototype.le = function(a, b) {
        this.ub() ? Id(this, a, b) : (void 0 != a && a != this.B.statusText && (this.B.statusText = a,
        this.Za = !0),
        void 0 != b && b != this.B.dialData && (this.B.dialData = b,
        this.Za = !0))
    }
    ;
    ...
    ;
    P.prototype.getSystemVolume = P.prototype.Pd;
    ...
    ;
    P.prototype.setInactivityTimeout = P.prototype.Pc;
    P.prototype.Oa = function(a, b) {
        ...
        if (!this.u[a]) {
            ...
            this.u[a] = new O(a,this.ja,Oa(this.T),b);
    ...
    ;
    P.prototype.sendFeedbackMessage = P.prototype.Mc;
    P.prototype.Zd = function(a) {
        ...
        case "opened":
            ...
            this.fa.send("SystemSender", d);
            this.B.maxInactivity && this.Pc(this.B.maxInactivity);
            break;
        case "closed":
            this.gc();
            break;
        ...
        case "ready":
            ...
            for (d in this.u)
                this.u[d].Wb = !0;
            this.Za && (this.Za = !1,
            Id(this, this.B.statusText, this.B.dialData));
        ...
        case "senderconnected":
            ...
            if (Hd(b.id))
                H(Q, "Ignored connection from " + b.id);
            else {
                ...
                for (c in this.u)
                    d = this.u[c],
                    e = b.id,
                    Pa(d.A, e) ? G(hd, "Unexpected sender already registered [" + d.S + ", " + e + "]") : (H(hd, "Registering sender [" + d.S + ", " + e + "]"),
                    d.A[e] = null);
                if (this.onSenderConnected)
                    this.onSenderConnected(a);
                this.c(a)
            }
            break;
        case "senderdisconnected":
            ...
            a = a.reason;
            if (Hd(c))
                H(Q, "Ignored disconnection from " + c);
            else {
                switch (a) {
                case "closed_by_peer":
                ...
                if (Pa(this.T, c)) {
                    ...
                    for (b in this.u)
                        d = this.u[b],
                        e = c,
                        Pa(d.A, e) && (H(hd, "Unregistering sender [" + d.S + ", " + e + "]"),
                        d.A[e] && d.A[e].close(),
                        delete d.A[e]);
                    if (this.onSenderDisconnected)
                        this.onSenderDisconnected(a);
                    this.c(a)
                } else
                    G(Q, "Unknown sender disconnected: " + c)
            }
            break;
        case "volumechanged":
            this.Wc = b = {
            ...
            b = new Nd(b);
            if (this.onSystemVolumeChanged)
                this.onSystemVolumeChanged(b);
            this.c(b);
            break;
        case "visibilitychanged":
            ...
            break;
        case "standbychanged":
            if (!this.Bb && (b = a.standby,
            b = m(b) ? b : null,
            b != this.Wa)) {
                H(Q, "Dispatching standby changed event " + b);
                this.Wa = b;
                b = new Pd(1 == b);
                if (this.onStandbyChanged)
                    this.onStandbyChanged(b);
                this.c(b)
            }
            break;
        ...
        case "feedbackstarted":
            ...
            b = new Rd;
            if (this.onFeedbackStarted)
                this.onFeedbackStarted(b);
            else
                this.Mc("");
            break;
        default:
    ...
    var Od = function(a, b) {
        if (b == a.Xa)
            H(Q, "Ignoring visibility changed event, state is already " + b);
        else {
            H(Q, "Dispatching visibility changed event " + b);
            a.Xa = b;
            b = new Sd(0 != b);
            if (a.onVisibilityChanged)
                a.onVisibilityChanged(b);
            a.c(b)
        }
    };
    ...
    var Jd = function(a, b) {
        if (!b)
            return G(Q, "Version not provided"),
            !1;
        if (!a.Fb)
            return G(Q, "No System Version"),
            !1;
        var c = b.split(".");
        if (!c.length)
            return G(Q, "Version provided is not valid: " + b),
            !1;
        var d = a.Fb.split(".");
        if (!d.length)
            return G(Q, "System Version format is not valid " + a.Fb),
            !1;
        for (var e = 0; e < c.length; e++) {
            var f = parseInt(c[e], 10);
            if (isNaN(f))
                return G(Q, "Version is not numeric: " + b),
                !1;
            var h = d.length > e ? parseInt(d[e], 10) : 0;
            if (isNaN(h))
                return G(Q, "System Version is not numeric: " + a.Fb),
                !1;
            if (f > h)
                return !1
        }
    ...
    P.prototype.C = function() {
        ...
        document && dc(document, "visibilitychange", this.Dc, !1, this);
        delete P.rb;
        Ib(Q, "Disposed " + this.aa())
    }
    ;
    ...
    var Ud = function() {
        this.$ = P.ba();
        this.R = this.$.Oa("urn:x-cast:com.google.cast.broadcast", "JSON");
        this.R.onMessage = this.L.bind(this)
    };
    Ud.prototype.L = function(a) {
        if (this.$.ub())
            Hb(Vd, "Ignoring broadcast request, system is ready.");
        else {
            a = a.data;
            var b = a.type;
            if ("APPLICATION_BROADCAST" != b)
                G(Vd, "Ignoring message type: " + b);
                ...
                if (c)
                    ...
                    G(Vd, "Invalid message bus for namespace: " + b)
            } else
                G(Vd, "Missing namespace: " + b)
        }
    }
    ;
    ja(Ud);
    ...
    var S = function() {
        ...
        this.R = P.ba().Oa("urn:x-cast:com.google.cast.cac", "JSON");
        this.R.onMessage = this.L.bind(this);
        this.Db = new Ya
    };
    ...
    S.prototype.L = function(a) {
        ...
        case "ERROR":
            c = b.requestId;
            (a = this.Db.get(c)) ? (this.Db.remove(c),
            a.resolve(b)) : Hb(Xd, "No matching request for response " + JSON.stringify(b));
            return;
        default:
            this.M("Unsupported event " + c, a, b, "INVALID_REQUEST");
            return
        }
        d ? Yd(this, a, b, d) : this.M("Handler for " + c + " not implemented", a, b, "INVALID_COMMAND")
    }
    ;
    var Yd = function(a, b, c, d) {
        ...
        Fc(d).then(function(d) {
            ...
            a.M("Got a rejected promise " + JSON.stringify(d), b, c, "APP_ERROR")
        })
    }
      , ae = function(a, b, c) {
        G(Xd, a);
      ...
      , Zd = function(a, b) {
        if (!b)
            return ae("No response data", a, "APP_ERROR");
        switch (b.type) {
        case "SUCCESS":
        case "ERROR":
    ...
    S.prototype.M = function(a, b, c, d) {
        this.R.send(b, ae(a, c, d))
    }
    ;
    S.prototype.ne = function(a, b) {
        if (null !== b && !r(b))
            throw G(Xd, "Given handler is not a function or null"),
        ...
        case "CUSTOM_COMMAND":
            ...
            break;
        default:
            throw a = "Cannot set handler for " + a,
            G(Xd, a),
            Error(a);
        }
    }
    ...
    S.prototype.$d = function(a, b) {
        var c = qa();
        if (ab(this.Db.K, c))
            return Promise.reject(Error("Duplicate request"));
        a = new be(a,b);
        a.requestId = c;
        this.R.send("system-0", a);
        c = Hc();
    ...
    var we = function(a, b, c, d) {
        ...
        this.cd = "[" + this.Kb + '="true"]::cue ';
        this.dd = new RegExp(/^[\.'":%,;\s\-0-9a-z]+$/i);
        a = ia(b);
        for (b = a.next(); !b.done; b = a.next()) {
            b = b.value;
            ...
            if ("TEXT" == b.type && e) {
                ...
                if (0 == wa("vtt", e.substr(e.length - 3, 3)) || m(f) && 0 == wa(f, "text/vtt"))
                    e = document.createElement("track"),
                    e.src = b.trackContentId,
                    e.id = b.trackId,
                    e.label = b.name,
                    e.srclang = b.language,
                    e.kind = (b.subtype || "CAPTIONS").toLowerCase(),
                    this.za.push(e),
    ...
    var xe = function(a, b) {
        ...
        for (var c = a.next(); !c.done; c = a.next()) {
            var c = c.value
              , d = c.track;
            b(c) ? d.mode = "showing" : (d.mode = "showing",
            d.mode = "disabled")
        }
    }
      , ye = function(a) {
      ...
      , Ae = function(a) {
        ...
        for (var c = a.next(); !c.done; c = a.next())
            c = c.value,
            "showing" == c.track.mode && b.push(parseInt(c.id, 10));
        return b
    }
      , Be = function(a) {
        a.lb && (a.b.removeAttribute(a.Kb),
        document.head.removeChild(a.lb),
        a.Eb = null)
    }
      , Ce = function(a) {
        a.Nb && (a.b.removeAttribute("crossorigin"),
        a.Nb = !1)
    }
      , T = function(a, b, c) {
        1 == c || a.dd.test(b) ? a.Eb.insertRule(a.cd + "{ " + b + " }", a.Eb.cssRules.length) : Hb(De, "Invalid css cue: " + b)
    }
      , te = function(a) {
        Be(a);
        Ce(a);
        ...
        0 < a.za.length && !a.b.getAttribute("crossorigin") && (a.b.setAttribute("crossorigin", "anonymous"),
        a.Nb = !0)
    }
      , Ee = function(a, b) {
        var c;
        ...
        if (c)
            switch (a = "rgba(204, 204, 204, " + parseInt(a.substring(7, 9), 16) + ")",
            b) {
            case "OUTLINE":
      ...
      , ue = function(a, b) {
        ...
        m(b.edgeType) && (h = m(b.foregroundColor) ? b.foregroundColor : "#FFFFFFFF",
        b = m(b.edgeColor) ? Ee(b.edgeColor, b.edgeType) : Ee(h, b.edgeType),
        T(a, b, !0))
    };
    we.prototype.C = function() {
        I.prototype.C.call(this);
        for (var a = ia(this.za), b = a.next(); !b.done; b = a.next())
            this.b.removeChild(b.value);
        this.za.length = 0;
        Be(this);
        Ce(this);
        E(De, C, "Disposed " + this.aa())
    }
    ;
    ...
    var Ie = function(a) {
        ...
        if (null != a.Na)
            return a.Na;
        a.Na = 0 <= a.W ? Math.min(a.Gc + a.W, b) : Math.max(b + a.W, a.Fa);
        return a.Na
    }
      , He = function(a) {
        null != a.W && (dc(a.b, "timeupdate", a.Ec, !1, a),
        a.Na = null,
        a.W = null)
    };
    Ge.prototype.Ec = function() {
        Je(this)
    }
    ;
    var Je = function(a) {
        if (null == a.W)
            return !1;
        var b = Ie(a);
        return isNaN(b) ? !1 : a.b.currentTime >= b ? (a.zb(),
        !0) : !1
    };
    g = Ge.prototype;
    g.load = function(a, b, c, d, e) {
        ...
        this.v = null);
        this.Va = !1;
        d && d.tracks && this.b && (this.v && this.v.I(),
        this.v = new we(this.b,d.tracks,d.activeTrackIds || [],d.textTrackStyle || null),
        d.language && ze(this.v, d.language));
        null != this.W && K(this.b, "timeupdate", this.Ec, !1, this);
        e || (this.Fa = c && 0 < c ? c : 0,
        H(this.G, "Load - contentId: " + a + " autoplay: " + b + " time: " + this.Fa),
        this.b.autoplay = !1,
        a && (this.b.src = a),
        this.b.autoplay = b,
        this.b.load())
    ...
    g.fb = function(a, b, c, d, e) {
        if ("array" == ka(b))
            ...
            c = Zb(c),
            d = !!d,
            b = Pb(a) ? a.Qa(b, c, d, e) : a ? (a = $b(a)) ? a.Qa(b, c, d, e) : null : null,
            b && (ec(b),
            delete this.l[b.key]);
        return this
    }
    ...
    U.createSession = function(a, b) {
        ...
        a = new U(a,b);
        a.Ra.Ha(a.J, "message", a.Kc).Ha(a.J, "keystatuseschange", a.Kc);
        return a
    }
    ;
    U.prototype.generateRequest = function(a, b) {
        if ("persistent-release-message" == this.Sd) {
            if ("cenc" != a)
                throw Error("Only cenc initDataType is supported for persistent-release-message session type.");
    ...
    ;
    Pe.setLevelValue = Pe.Qc;
    if (Pe) {
        var Qe = 1E3;
        if (document.currentScript) {
            var Re = document.currentScript.src;
            if (Re.includes("/df/cast/sdk/") || Re.includes("/staging/cast/sdk/"))
                Qe = 800
        }
    ...
    g.contains = function(a) {
        return 0 <= Da(this.P, a) || 0 <= Da(this.U, a)
    }
    ;
    g.remove = function(a) {
        var b;
    ...
    ;
    g.tc = function() {
        for (var a = [], b = this.P.length - 1; 0 <= b; --b)
            a.push(this.P[b]);
        for (var c = this.U.length, b = 0; b < c; ++b)
            a.push(this.U[b]);
        return a
    }
    ;
    ...
    ;
    V.prototype.getLength = V.prototype.Hd;
    V.prototype.Ld = function() {
        return this.X
    }
    ;
    V.prototype.getRepeatMode = V.prototype.Ld;
    ...
    ;
    V.prototype.getCurrentItemId = V.prototype.Fd;
    ...
    var We = function(a, b) {
      ...
      , Xe = function(a) {
        return "REPEAT_ALL_AND_SHUFFLE" == a.X
    }
      , Ye = function(a, b) {
      ...
      , Ze = function(a) {
        return "REPEAT_ALL_AND_SHUFFLE" == a.X || "REPEAT_ALL" == a.X
    };
    ...
    var $e = function(a, b) {
      ...
      , bf = function(a, b, c) {
        ...
        b = a.j + b;
        var d = !1;
        b >= a.a.length ? (b = Ze(a) ? b % a.a.length : -1,
        d = !0) : 0 > b && (b = Ze(a) ? a.a.length + (b + 1) % a.a.length - 1 : 0,
        d = !0);
        c && (a.j = b);
        return -1 == b ? "QUEUE_ENDED" : d ? Xe(a) ? (af(a),
        "QUEUE_SHUFFLED") : "QUEUE_LOOP" : "QUEUE_ACTIVE"
    }
      , af = function(a) {
        var b = a.a.length, c, d;
        if (!(3 > a.a.length))
            for (; 0 < b; )
    ...
    var W = function(a, b, c) {
        ...
        this.ae = 1;
        this.ue = b || 15;
        this.Uc = this.zc = this.Ga = this.ka = this.i = this.f = null;
        this.da = !1;
        this.o = this.ca = this.s = null;
        this.tb = !0;
        this.La = null;
        this.Jb = this.ad.bind(this);
        this.g = null;
        this.Gb = !1;
        this.sa = null;
        this.Yb = 1;
        ...
        this.vb = new Te;
        this.Ta = !1;
        this.customizedStatusCallback = this.ed;
        this.onLoad = this.nd;
        this.onPlay = this.rd;
        ...
        this.onStop = this.zd;
        this.onSetVolume = this.yd;
        this.onEditTracksInfo = this.hd;
        this.onEditAudioTracks = this.gd;
        ...
        this.onEnded = this.jd;
        this.onQueueEnded = this.sd;
        this.onAbort = n;
        this.onError = this.kd;
        this.onMediaStatus = this.onLocalRequestError = n;
        this.onCancelPreload = this.onPreload = this.onPrecache = null;
    ...
    ;
    W.prototype.getMediaInformation = W.prototype.Id;
    W.prototype.Jd = function() {
        return this.g
    }
    ;
    W.prototype.getMediaQueue = W.prototype.Jd;
    W.prototype.Rd = function(a, b, c, d, e) {
        a = new df(a);
    ...
    ;
    W.prototype.insertQueueItems = W.prototype.Rd;
    ...
    var gf = function(a) {
      ...
      , hf = function(a, b) {
        ...
        for (var c = a.next(); !c.done; c = a.next())
            if (c = c.value,
            "TEXT" == c.type && m(c.language) && ra(c.language, b))
                return !0;
        return !1
    }
      , jf = function(a, b) {
        ...
        for (var c = 0, d = 0, e = 0; e < b.length; e++) {
            ...
            if (!f)
                return G(X, "Track ID does not exist: " + b[e]),
                !1;
            "AUDIO" == a[h].type ? d++ : "VIDEO" == a[h].type && c++;
            if (1 < d || 1 < c)
                return G(X, "Maximum one active video and one active audio track supported"),
                !1
        }
        return !0
    }
      , ef = function(a, b, c) {
        c.mediaSessionId = a.ea;
    ...
    W.prototype.cc = function(a) {
        ...
        if (!this.Ta || this.vb.Ub() && "LOAD" == c) {
            ...
            if (q(e) && e == Math.floor(e)) {
                var f = !1;
                void 0 != b.mediaSessionId && b.mediaSessionId != this.ea ? (G(X, "Invalid media session ID: " + b.mediaSessionId + "  does not match the expected ID: " + this.ea),
                f = !0) : "LOAD" != d && "PLAY_AGAIN" != d && "GET_STATUS" != d && "QUEUE_LOAD" != d && "PRECACHE" != d && (m(b.mediaSessionId) ? "IDLE" == kf(this) && (G(X, "Unexpected command, player is in IDLE state so the media session ID is not valid yet"),
                f = !0) : (G(X, "Invalid media session ID, it is undefined"),
                f = !0));
                f ? (this.wa(a, e, "INVALID_REQUEST", "INVALID_MEDIA_SESSION_ID"),
                d = !1) : (E(X, C, "MediaManager message received"),
                d = !0)
            } else
                G(X, "Ignoring request, requestId is not an integer: " + e),
                d = !1;
            if (d) {
                d = b.requestId;
                delete b.type;
                ...
                case "GET_STATUS":
                    ...
                    break;
                case "PLAY":
                    H(X, "Dispatching MediaManager play event");
                    b = new Y("play",b,a);
                    if (this.onPlay)
                        this.onPlay(b);
                    this.c(b);
                ...
                case "SEEK":
                    if (m(b.currentTime) || m(b.relativeTime)) {
                        ...
                        G(X, "currentTime or relativeTime is required"),
                        e = {
                ...
                case "SET_VOLUME":
                    if (b.volume && (m(b.volume.level) || m(b.volume.muted)))
                        if (void 0 != b.volume.level && 0 > b.volume.level || 1 < b.volume.level)
                            G(X, "volume level is invalid"),
                            e = {
                                type: "INVALID_REQUEST",
                                reason: "INVALID_PARAMS"
                            };
                ...
                case "EDIT_TRACKS_INFO":
                    ...
                    if (jf(this.i.media.tracks, b.activeTrackIds)) {
                        ...
                        if (this.onEditTracksInfo)
                            this.onEditTracksInfo(c);
                        this.c(c);
                        e = null
                    } else
                        G(X, "Invalid track info"),
                        e = {
                            type: "INVALID_REQUEST",
                            reason: "INVALID_PARAMS"
                        };
                ...
                case "EDIT_AUDIO_TRACKS":
                    ...
                    if (this.onEditAudioTracks)
                        this.onEditAudioTracks(b);
                    this.c(b);
                    e = null;
                    break;
                case "QUEUE_LOAD":
                    ...
                    c = !1;
                    if (m(b.startIndex) && (!q(b.startIndex) || 0 > b.startIndex))
                        G(X, "Invalid startIndex"),
                        e = {
                            type: "INVALID_REQUEST",
                            reason: "INVALID_PARAMS"
                        };
                        ...
                        e = (b.startIndex || 0) + 1;
                        if (!b.items || b.items.length < e)
                            G(X, "Invalid number of items"),
                            c = !0;
                        else if (b.repeatMode && !yd(b.repeatMode))
                            G(X, "Invalid repeatMode"),
                            c = !0;
                        else
                            for (e = 0; e < b.items.length; e++)
                                b.items[e].media ? m(b.items[e].itemId) ? (G(X, "ItemId is not undefined, element at index: " + e),
                                c = !0) : b.items[e].itemId = this.Yb++ : (G(X, "Media is mandatory, missing in element at index: " + e),
                                c = !0);
                        if (c)
                            e = {
                                type: "INVALID_REQUEST",
                ...
                case "QUEUE_INSERT":
                    ...
                    if (this.g)
                        if (b.items && 0 != b.items.length)
                            if (m(b.currentItemId) && m(b.currentItemIndex))
                                G(X, "Maximum one currentItem must be provided"),
                                c = !0;
                            else if (m(b.currentItemIndex) && (!q(b.currentItemIndex) || 0 > b.currentItemIndex || b.currentItemIndex >= b.items.length))
                                G(X, "Invalid currentItemIndex"),
                                c = !0;
                            else if (m(b.currentItemId) && (!q(b.currentItemId) || 0 > b.currentItemId))
                                G(X, "Invalid currentItemId"),
                                c = !0;
                            else
                                for (e = 0; e < b.items.length; e++)
                                    if (q(b.items[e].itemId)) {
                                        ...
                                        b.items[e].itemId = this.Yb++;
                        else
                            G(X, "No items to insert"),
                            c = !0;
                    else
                        G(X, "Queue does not exist"),
                        c = !0;
                    if (c)
                        e = {
                            type: "INVALID_REQUEST",
                        ...
                        if (this.onQueueInsert)
                            this.onQueueInsert(b);
                        this.c(b);
                        e = null
                    }
                    break;
                case "QUEUE_UPDATE":
                    ...
                    c = !1;
                    this.g ? b.items && !nf(b.items) ? c = !0 : b.repeatMode && !yd(b.repeatMode) && (G(X, "Invalid repeatMode"),
                    c = !0) : (G(X, "Queue does not exist"),
                    c = !0);
                    if (c)
                        e = {
                            type: "INVALID_REQUEST",
                ...
                case "QUEUE_REMOVE":
                    ...
                    c = !1;
                    this.g ? b.itemIds && 0 != b.itemIds.length ? of(b.itemIds) || (c = !0) : (G(X, "No itemIds to remove"),
                    c = !0) : (G(X, "Queue does not exist"),
                    c = !0);
                    if (c)
                        e = {
                        ...
                        if (this.onQueueRemove)
                            this.onQueueRemove(b);
                        this.c(b);
                        e = null
                    }
                    break;
                case "QUEUE_REORDER":
                    ...
                    c = !1;
                    this.g ? b.itemIds && 0 != b.itemIds.length ? of(b.itemIds) ? m(b.insertBefore) && 0 <= Da(b.itemIds, b.insertBefore) && (G(X, "insertBefore can not be one of the reordered items"),
                    c = !0) : c = !0 : (G(X, "No itemIds to reorder"),
                    c = !0) : (G(X, "Queue does not exist"),
                    c = !0);
                    if (c)
                        e = {
                        ...
                        if (this.onQueueReorder)
                            this.onQueueReorder(b);
                        this.c(b);
                        e = null
                    }
                    break;
                case "PRECACHE":
                    ...
                    break;
                default:
                    G(X, "Unexpected message type: " + c),
                    e = {
                        type: "INVALID_REQUEST",
                        reason: "INVALID_COMMAND"
                    }
                }
                e && (G(X, "Sending error: " + e.type + " " + e.reason),
                this.onLocalRequestError && a == this.na ? (e.requestId = d,
                this.onLocalRequestError(e)) : this.wa(a, d, e.type, e.reason))
            }
        } else
            this.vb.enqueue(a)
    }
    ...
    var kf = function(a) {
        if (!a.i)
            return "IDLE";
        var b = a.f.getState();
        return "PLAYING" == b && a.da ? "BUFFERING" : b
    }
      , pf = function(a, b, c, d) {
        var e = {
            type: "MEDIA_STATUS"
        ...
        var t = a.hb
          , t = t.Z ? t.Z.videoWidth : 0
          , y = a.hb
          , y = y.Z ? y.Z.videoHeight : 0;
        0 < t && 0 < y && (h.videoInfo = new vd(t,y,a.hb.uc));
        if (a.i)
            b && (h.media = a.i.media || void 0),
            h.currentItemId = a.i.itemId;
        else if (a.ka && (b && (h.media = a.ka.media || void 0),
        h.currentItemId = a.ka.itemId,
        a.ka = null),
        a.g && (t = a.g.Ea()))
            h.loadingItemId = t.itemId;
        "IDLE" == h.playerState ? (a.ca && (h.idleReason = a.ca),
        f && (h.extendedStatus = new wd("LOADING",f))) : a.ca = null;
        void 0 != c && (h.customData = c);
        a.g && (d && (h.items = a.g.rc(b)),
        h.repeatMode = a.g.X);
        a.customizedStatusCallback ? (a = a.customizedStatusCallback(h),
        null == a ? e = null : e.status = [a]) : e.status = [h];
        return e
    }
      , qf = function(a) {
        null != a.Ya && (l.clearTimeout(a.Ya),
        a.Ya = null)
    }
      , rf = function(a) {
    ...
    W.prototype.ad = function() {
        ...
        if ("IDLE" != a && "PAUSED" != a) {
            ...
            var b = this.da;
            this.da = 100 > 1E3 * (this.Ga - a);
            b != this.da ? (E(X, C, "Buffering state changed, isPlayerBuffering: " + this.da + " old time: " + a + " current time: " + this.Ga),
            this.m(!1)) : this.da || (a = 1E3 * (this.Ga - this.zc) - (Date.now() - this.Uc),
            1E3 < a || -1E3 > a ? (E(X, C, "Time drifted: " + a),
            this.m(!1)) : this.i && this.g && (a = this.g,
            (a = 0 > a.j ? null : "REPEAT_SINGLE" == a.X ? a.a[a.j] : a.j + 1 >= a.a.length && (Xe(a) || "REPEAT_OFF" == a.X) ? null : a.a[(a.j + 1) % a.a.length]) && q(a.preloadTime) && this.i.media && !this.s && sf(this, a.preloadTime) && this.sa != a.itemId && (this.onPreload ? (Ba(a.itemId),
            b = new tf(a.itemId),
            b.requestId = 0,
            b.mediaSessionId = this.ea,
            b.autoplay = a.autoplay,
            b.currentTime = a.startTime,
            b.customData = a.customData || null,
            b.activeTrackIds = a.activeTrackIds,
            b.media = a.media,
            b = new Y("preload",b,""),
            Ba(a.itemId),
            this.sa = a.itemId,
            H(X, "Sending preload event: " + JSON.stringify(b)),
            this.onPreload(b) && this.m(!1)) : H(X, "Not sending preload event"))))
        }
    }
    ;
    W.prototype.m = function(a, b, c, d) {
        if (this.f) {
            if (E(X, C, "Sending broadcast status message"),
            a = pf(this, a, c, d),
            null != a) {
                if (this.onMediaStatus && a.status)
                    this.onMediaStatus(a.status[0] || null);
                a.requestId = b || 0;
                this.wb.mc(a);
                rf(this)
            }
        } else
            G(X, "Not sending broadcast status message, state is invalid")
    }
    ;
    ...
    W.prototype.Oc = function(a, b, c, d, e) {
        if (this.f) {
            if (E(X, C, "Sending status message to " + a),
            c = pf(this, c, d, e),
            null != c) {
                if (this.onMediaStatus && c.status)
                    this.onMediaStatus(c.status[0] || null);
                c.requestId = b;
                this.wb.send(a, c);
                rf(this)
            }
        } else
            G(X, "State is invalid"),
            this.wa(a, b, "INVALID_PLAYER_STATE", null, d)
    }
    ;
    W.prototype.sendStatus = W.prototype.Oc;
    ...
    var lf = function(a, b, c, d, e, f) {
        ...
        var h = !1;
        c.media ? c.media.tracks && !gf(c.media.tracks) ? (G(X, "Invalid tracks information"),
        h = !0) : c.activeTrackIds && !jf(c.media.tracks, c.activeTrackIds) && (h = !0) : (G(X, "Media is mandatory"),
        h = !0);
        if (h)
            return f && f(),
            {
        ...
        a.s ? a.jc("LOAD_CANCELLED") : a.i && (a.va("INTERRUPTED", !1),
        f = a.m.bind(a, !0));
        a.s = {
            senderId: b,
            message: c
        ...
        d && (a.ea++,
        a.ca = null,
        e ? a.g = e : (d = new Ve(a.Yb++),
        d.media = c.media,
        d.autoplay = c.autoplay,
        d.activeTrackIds = c.activeTrackIds,
        d.customData = c.customData,
        a.g = new V([d],"REPEAT_OFF",0)));
        a.i = a.g && a.g.Ea();
        qf(a);
        a.la = c;
        a.tb && a.f.Fc && a.f.Fc(m(c.autoplay) ? c.autoplay : !0, 0 < c.currentTime ? c.currentTime : 0, a.i.playbackDuration, a.i.startTime);
        b = new Y("load",c,b);
        if (a.onLoad)
            a.onLoad(b);
        a.c(b);
    ...
    W.prototype.Vd = function(a) {
        ...
        if (a.tracks && !gf(a.tracks))
            return G(X, "Invalid tracks information"),
            !1;
        if (a.activeTrackIds && !jf(a.tracks, a.activeTrackIds))
            return G(X, "Invalid active tracks"),
            !1;
        this.o = a.activeTrackIds || null;
        if (this.g) {
            var b = this.g.Ea();
            b && b.media && (b.media.tracks = a.tracks,
    ...
    ;
    W.prototype.loadTracksInfo = W.prototype.Vd;
    W.prototype.Rc = function(a) {
        if (a != this.f) {
            this.f && (this.f.unregisterErrorCallback(),
            this.f.unregisterEndedCallback(),
            this.f.unregisterLoadCallback());
            ...
            var b = this.hb;
            b.Z && b.Z.removeEventListener("resize", b.Ic);
            var c = null;
            a.tagName && "video" == a.tagName.toLowerCase() ? c = a : (a = document.getElementsByTagName("video"),
            1 == a.length && (c = a[0]));
            b.Z = c;
            b.Z && b.Z.addEventListener("resize", b.Ic)
        }
    }
    ;
    W.prototype.setMediaElement = W.prototype.Rc;
    W.prototype.dc = function() {
        if (this.s)
            if (H(X, "Metadata loaded"),
            this.i && this.i.media && (this.i.media.duration = this.f.getDurationSec()),
            this.da = !0,
            this.onMetadataLoaded)
                this.onMetadataLoaded(this.s);
            else
                uf(this)
    }
    ;
    ...
    W.prototype.$b = function(a) {
        if (this.s)
            if (G(X, "Load metadata error: " + a),
            this.onLoadMetadataError)
                this.onLoadMetadataError(this.s);
            else
                uf(this);
    ...
    W.prototype.jc = function(a, b) {
        if (this.s) {
            ...
            if (this.s.senderId == this.na) {
                if (this.onLocalRequestError)
                    this.onLocalRequestError({
                        type: a
                    })
            } else
                this.wa(this.s.senderId, this.s.message.requestId, a, null, b);
            uf(this)
        } else
            G(X, "Not sending LOAD error as there is no on going LOAD request")
    }
    ;
    ...
    W.prototype.Nc = function(a) {
        if (this.s) {
            ...
            G(X, "Not sending status as there is no on going LOAD request")
    }
    ;
    W.prototype.sendLoadComplete = W.prototype.Nc;
    g = W.prototype;
    g.kd = function() {
        this.va("ERROR")
    }
    ;
    g.md = function() {
        this.s && "" == this.s.senderId && this.s.message && 0 == this.s.message.requestId ? this.va("ERROR", !0) : (this.va("ERROR", !1),
        this.jc("LOAD_FAILED"))
    }
    ;
    g.zb = function() {
    ...
    g.jd = function() {
        if (this.g) {
            ...
            this.Cb = -1;
            vf(this, "REPEAT_SINGLE" == this.g.X ? 0 : 1, !1, a, void 0, void 0, void 0, "FINISHED")
        }
    }
    ;
    g.sd = function(a, b) {
    ...
    var vf = function(a, b, c, d, e, f, h, t) {
        ...
        if (a.g && "QUEUE_ENDED" != bf(a.g, b, !1)) {
            ...
            if (b = wf(a, a.g.Ea(), void 0, h)) {
                ...
                a.ka = a.i,
                a.i = null,
                "QUEUE_SHUFFLED" == y && (f = !0),
                "INTERRUPTED" == a.ca))
                    a.onAbort();
                lf(a, "", b, !1, void 0, a.m.bind(a, c, d, e, f))
            } else if (a.onQueueEnded)
                a.onQueueEnded(t, d)
        } else if (a.onQueueEnded)
            a.onQueueEnded(t, d)
    };
    ...
    g.ld = function(a) {
        ...
        var c = !0
          , d = !0;
        b.options && (b.options & 1 && (c = !1),
        b.options & 1 && (d = !1));
        this.Oc(a.senderId, a.data.requestId, c, null, d)
    }
    ;
    g.rd = function(a) {
        E(X, C, "onPlay");
    ...
    g.qd = function(a) {
        E(X, C, "onPlayAgain");
        this.i ? (this.f.seek(0),
        this.f.play(),
        this.m(!1, a.data.requestId)) : this.la && (this.la.type = "LOAD",
        this.la.autoplay = !0,
        ef(this, this.na, this.la))
    }
    ;
    g.xd = function(a) {
        a = a.data;
        ...
        "PAUSED" != this.f.getState() && (this.da = !0);
    ...
    g.va = function(a, b, c, d) {
        ...
        this.ka = this.i,
        this.i = null,
        b && this.m(!1, c, d, void 0)) : H(X, "Nothing to reset, Media is already null");
        this.la && (qf(this),
        this.Ya = Sc(function() {
            e.la = null;
            e.Ya = null
    ...
    W.prototype.hd = function(a) {
        ...
        this.f.editTracksInfo && (this.o = this.f.editTracksInfo(a)),
        this.m(b.textTrackStyle ? !0 : !1, b.requestId)) : (G(X, "Invalid track language"),
        this.wa(a.senderId, b.requestId, "INVALID_REQUEST", "LANGUAGE_NOT_SUPPORTED"))
    }
    ;
    ...
    var of = function(a) {
        ...
        for (var b = 0; b < a.length; b++)
            for (var c = b + 1; c < a.length; c++)
                if (a[b] == a[c])
                    return G(X, "Duplicate itemId: " + a[b] + "at positions:" + b + " " + c),
                    !1;
        return !0
    }
      , nf = function(a) {
        for (var b = 0; b < a.length; b++) {
            if (!q(a[b].itemId))
                return G(X, "Invalid itemId at position: " + b),
                !1;
            for (var c = b + 1; c < a.length; c++) {
                if (!q(a[c].itemId))
                    return G(X, "Invalid itemId at position: " + c),
                    !1;
                if (a[b].itemId == a[c].itemId)
                    return G(X, "Duplicate itemId: " + a[b].itemId + "at positions:" + b + " " + c),
                    !1
            }
        }
        return !0
      ...
      , sf = function(a, b) {
        if (a.i.media.duration - a.f.getCurrentTimeSec() <= b)
            return !0;
        if (null == a.sa)
            return !1;
        a.sa = null;
        if (!a.onCancelPreload)
            return !1;
        b = new Z;
        b.requestId = 0;
        b.mediaSessionId = a.ea;
    ...
    g.oc = function(a) {
        ...
        if (this.Gb) {
            ...
            q(b.jump) && (a = !0);
            b.repeatMode && (this.g.X = b.repeatMode);
            if (b.items && 0 < b.items.length) {
            ...
            a = a.senderId,
            "__inject__" == a && this.onQueueUpdate == this.oc ? this.wa(a, b.requestId, "INVALID_REQUEST", "INVALID_COMMAND") : (H(X, "QUEUE_UPDATE request ignored"),
            this.m(!1, b.requestId))
    }
    ;
    g.vd = function(a) {
        a = a.data;
    ...
    g.wd = function(a) {
        ...
        if (a.itemIds && 0 < a.itemIds.length) {
            var b = this.g
              ...
              , e = a.insertBefore;
            if (d && 0 != d.length) {
                for (var f = b.a[b.j].itemId, h = m(e) ? e : -1, e = b.a.length - d.length, t = [], y = -1 == h ? !0 : !1, F = 0; F < b.a.length; F++)
                    0 <= Da(d, b.a[F].itemId) ? y || b.a[F].itemId != d[0] || (e = t.length) : (t.push(b.a[F]),
                    h == b.a[F].itemId && (e = t.length - 1,
                    y = !0));
                h = [];
